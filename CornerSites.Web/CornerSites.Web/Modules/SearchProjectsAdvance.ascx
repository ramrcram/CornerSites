<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchProjectsAdvance.ascx.cs" 
    Inherits="CornerSites.Web.Modules.SearchProjectsAdvance" %>
        ...
        <tr>
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="rfvddltype" ErrorMessage="Select Property Type" ControlToValidate="ddlPropertyType" 
                                InitialValue="-1" runat="server" ValidationGroup="AdvProject">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="rfdLocation" ErrorMessage="Select Property Type" ControlToValidate="txtLocation" 
                                runat="server" ValidationGroup="AdvProject">
                            *</asp:RequiredFieldValidator>
                        </td>                        
                    </tr>
                </table>
            ...
            <td width="250">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="btnSearch" runat="server" onclick="btnSearch_Click"  Text="Search" ValidationGroup="AdvProject" />
                        </td>
                    </tr>
                </table>
            </td>
